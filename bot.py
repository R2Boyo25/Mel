...
async def on_command_error(ctx: commands.Context, error: Exception) -> None:
    ...
    if str(error) == 'MissingPermission':
        ...
        embed = discord.Embed(title="Unknown Error", description="Users: Check to see if you made any mistakes with your command.\nDevs: Check the log channel for errors.", color=0x9c0b21)
        await ctx.send(embed=embed)
